...
def test_list_sec_applications_model_from_url():
    ...
    # http_future = sec_applications.bravado_service_operations.listSecApplication(container=container)
...
def test_list_sec_applications_model_save_from_url():
    ...
    # operation_name = 'listSecApplication'
    ...
    # http_future = sec_applications.bravado_service_operations.listSecApplication(container=container, _request_options={"headers": {"Accept": ','.join(callable_operation.operation.produces)}})
    http_future = sec_applications.service_operations.list_sec_application(container=container)
...
def test_query_objects(setup_gc30003_model_query):
    ...
    # http_client: IaaSRequestsHTTPClient = IaaSRequestsHTTPClient(idm_cfg=idm_cfg)
    objects: QuerySet = SecApplicationModel.objects()
    assert objects
