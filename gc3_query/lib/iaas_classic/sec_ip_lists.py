...
"""
gc3-query.sec_ip_lists    [9/8/2018 1:24 PM]
~~~~~~~~~~~~~~~~
...
class SecIPLists(IaaSServiceBase):
    ...
    # def get_all_sec_ip_lists(self):
    #     container = f"{self.idm_container_name}"
    #     http_future = self.service_operations.list_sec_ip_list(container=container)
    #     # http_future = self.service_operations.list_sec_ip_list(container=self.idm_root_container_name)
