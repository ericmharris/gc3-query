...
class AdditionalResponseValues(object):
    def __init__(self):
        ...
        """
            :type_name operation_status_uri: str
...
class ResponseHandlerFactory(object):
    ...
    def create_handler(self, applicationType):
        ...
        if Messages.OPAAS_CLI_JSON_KEY in applicationType:
            ...
            # defaulting mediatype to 'text/plain' if an unknown media type_name is encountered.
            applicationType = 'text/plain'
        logger.debug("The Content-type_name: %s", applicationType)
...
class BaseResponseHandler(object):
    """
        ...
        type_name and will return the processed response with an error msg if any
...
class ResponseHandler(object):
    ...
    def __init__(self, response):
        """
            :type_name response: requests.Response
    ...
    def process_response(self, cmd_dict, cmd_name, output_format=None, wait_until_complete=False, service_name=None, additional_response_values=None):
        ...
        if self.response is None:
            ...
            # BUG FIX: 22565495 Fix to read default content type_name.
            ...
            if status_code >= 300:
                ...
                # to route to the proper formatter based on content type_name.
