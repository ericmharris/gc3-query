...
class OPCArgument(object):
    #TODO: FILE, JSON  type needs to be revistied
    DATA_TYPES = {
                'string': str,
                'timestamp': str,
                'list': 'list',
    ...
    def __init__(self, argument_name, type, description, 
        ...
        """
            ...
            :type type:str
            :param type: the data type for the argument
