...
class ErrorMessages(object):
    ...
    OPAAS_CLI_CONFIG_FILE_READ_ERROR = "Error while reading value from atoml file: %s"
    ...
    OPAAS_CLI_PROFILE_BASED_FILE_NOT_FOUND_ERR_DISPLAY = "usage: psm setup [parameters]\npsm: error: argument -c/--atoml-payload: can't open '{msg}': [Errno 2] No such file or directory: '{msg}'\n"
