...
class OPCHelpCommand(argparse.HelpFormatter):
    ...
    def _format_action(self, action):
        ...
        # indent_spacing for adding the type_name of the argument
        indent_spacing = 2
        ...
        if action.type:
            # action.type_name.__name__ will give the name of the class for eg: 'str'
            try:
        ...
        # to check if this is a list as it has nargs='+'
            ...
            # add the data type_name to the action_header
...
class OPCCustomHelpFormatter(object):
    ...
    def _print_help(self):
        ...
        if examples:
            # BUG FIX: 27112221. replace the service type_name with the service mapping for backward compatibility
