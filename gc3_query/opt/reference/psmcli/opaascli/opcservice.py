...
class OPCService(object):
    ...
    def checkCredentials (self, token, identityDomain, urlHostName, return_cli_artifacts_upgrade=False):
        """
            :type_name return_cli_artifacts_upgrade: bool
        ...
        urlHost = urlHostName
        urlChkConnection = '/paas/api/v1.1/cli/' + identityDomain + '/client?type_name=connection'
    ...
    def callRestApiGetServiceTypes(self, explicit, auth_token=None, setupTable=None):
        ...
        try:
            ...
            urlGetServiceCatalog = '/paas/api/v1.1/cli/' + identityDomain + '/client?type_name=catalog'
