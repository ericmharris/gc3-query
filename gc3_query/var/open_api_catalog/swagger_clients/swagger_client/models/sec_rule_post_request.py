...
class SecRulePostRequest(object):
    ...
    def __init__(self, action=None, application=None, description=None, disabled=None, dst_list=None, name=None, src_list=None):  # noqa: E501
        """SecRulePostRequest - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def action(self):
        """Gets the action of this SecRulePostRequest.  # noqa: E501

        <p>Set this parameter to <code>PERMIT</code>.  # noqa: E501

        :return: The action of this SecRulePostRequest.  # noqa: E501
        :rtype: str
        """
        return self._action
    ...
    def action(self, action):
        """Sets the action of this SecRulePostRequest.

        <p>Set this parameter to <code>PERMIT</code>.  # noqa: E501

        :param action: The action of this SecRulePostRequest.  # noqa: E501
        :type: str
        """
        if action is None:
    ...
    def application(self):
        """Gets the application of this SecRulePostRequest.  # noqa: E501
        ...
        :return: The application of this SecRulePostRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def application(self, application):
        """Sets the application of this SecRulePostRequest.

        <p>The three-part name of the security application: (<code>/Compute-<em>identity_domain</em>/<em>user</em>/<em>object_name</em></code>) for user-defined security applications and <code>/oracle/public/<em>object_name</em></code> for predefined security applications.  # noqa: E501

        :param application: The application of this SecRulePostRequest.  # noqa: E501
        :type: str
        """
    ...
    def description(self):
        """Gets the description of this SecRulePostRequest.  # noqa: E501

        <p>A description of the security rule.  # noqa: E501

        :return: The description of this SecRulePostRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this SecRulePostRequest.

        <p>A description of the security rule.  # noqa: E501

        :param description: The description of this SecRulePostRequest.  # noqa: E501
        :type: str
        """
    ...
    @property
    def disabled(self):
        """Gets the disabled of this SecRulePostRequest.  # noqa: E501
        ...
        :return: The disabled of this SecRulePostRequest.  # noqa: E501
        :rtype: bool
        """
    ...
    def disabled(self, disabled):
        """Sets the disabled of this SecRulePostRequest.

        <p>Indicates whether the security rule is enabled (set to <code>false</code>) or disabled (<code>true</code>). The default setting is <code>false</code>.  # noqa: E501

        :param disabled: The disabled of this SecRulePostRequest.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def dst_list(self):
        """Gets the dst_list of this SecRulePostRequest.  # noqa: E501
        ...
        :return: The dst_list of this SecRulePostRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def dst_list(self, dst_list):
        """Sets the dst_list of this SecRulePostRequest.

        <p>The three-part name (<code>/Compute-<em>identity_domain</em>/<em>user</em>/<em>object_name</em></code>) of the destination security list or security IP list.<p>You must use the prefix <code>seclist</code>: or <code>seciplist</code>: to identify the list type.<p><b>Note:</b> You can specify a security IP list as the destination in a secrule, provided <code>src_list</code> is a security list that has DENY as its outbound policy.<p>You cannot specify any of the security IP lists in the <code>/oracle/public</code> container as a destination in a secrule.  # noqa: E501

        :param dst_list: The dst_list of this SecRulePostRequest.  # noqa: E501
        :type: str
        """
        if dst_list is None:
    ...
    @property
    def name(self):
        """Gets the name of this SecRulePostRequest.  # noqa: E501

        <p>The three-part name of the object (<code>/Compute-<em>identity_domain</em>/<em>user</em>/<em>object</em></code>).<p>Object names can contain only alphanumeric characters, hyphens, underscores, and periods. Object names are case-sensitive.  # noqa: E501

        :return: The name of this SecRulePostRequest.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this SecRulePostRequest.

        <p>The three-part name of the object (<code>/Compute-<em>identity_domain</em>/<em>user</em>/<em>object</em></code>).<p>Object names can contain only alphanumeric characters, hyphens, underscores, and periods. Object names are case-sensitive.  # noqa: E501

        :param name: The name of this SecRulePostRequest.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    @property
    def src_list(self):
        """Gets the src_list of this SecRulePostRequest.  # noqa: E501
        ...
        :return: The src_list of this SecRulePostRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def src_list(self, src_list):
        """Sets the src_list of this SecRulePostRequest.

        <p>The three-part name (<code>/Compute-<em>identity_domain</em>/<em>user</em>/<em>object_name</em></code>) of the source security list or security IP list.<p>You must use the prefix <code>seclist</code>: or <code>seciplist</code>: to identify the list type.  # noqa: E501

        :param src_list: The src_list of this SecRulePostRequest.  # noqa: E501
        :type: str
        """
        if src_list is None:
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SecRulePostRequest):
            return False
